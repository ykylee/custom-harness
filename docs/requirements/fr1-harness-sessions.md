...
- 상태: approved (v1.2, 2026-09-03 — 창 닫기 시 앱 소유 데몬 종료로 수명주기 정책 변경. v1.1: 2026-08-31)
- 최종 수정일: 2026-09-03
...
| FR-1.1.5 | 데몬 자체는 셸(Electron)이 detached 로 spawn 하되, **앱 창을 닫으면 셸이 소유한 데몬도 정상 종료**한다. CLI 소유 데몬은 셸이 종료하지 않는다. 데몬 소유권 구분은 FR-5.2 | S | M2 |
